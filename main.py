...
Note you need bokeh 0.13.0 and nodejs 8.9.3 
in addition to the latest version of anaconda
to run this file. In addition, this looks for the matrix 
file output "hw1.out" in the same directory
as this one in order to plot.
